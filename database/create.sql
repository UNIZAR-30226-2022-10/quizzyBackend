...
(
	GAME_ID				SERIAL PRIMARY KEY,
	FINISHED			BOOLEAN DEFAULT FALSE NOT NULL,
	PAIRING 			BOOLEAN DEFAULT TRUE NOT NULL,
	WINNER				VARCHAR(20),
...
CREATE TABLE PUBLIC_CHAT (
	...
	NICKNAME			VARCHAR(20),
	MESSAGE				VARCHAR(150),
	FOREIGN KEY (GAME_ID, NICKNAME) REFERENCES PUBLIC_GAMES_STATE(GAME_ID, NICKNAME) ON DELETE CASCADE
);
...
CREATE TABLE PRIVATE_CHAT (
	...
	NICKNAME			VARCHAR(20),
	MESSAGE				VARCHAR(150),
	FOREIGN KEY (GAME_ID, NICKNAME) REFERENCES PRIVATE_GAMES_STATE(GAME_ID, NICKNAME) ON DELETE CASCADE
);
...
CREATE TABLE GAME_INVITES (
    ...
    FOREIGN KEY(NICKNAME) REFERENCES USERS(NICKNAME) ON DELETE CASCADE,
    FOREIGN KEY(LEADER_NICKNAME) REFERENCES USERS(NICKNAME) ON DELETE CASCADE,
    PRIMARY KEY(NICKNAME, RID)
);
